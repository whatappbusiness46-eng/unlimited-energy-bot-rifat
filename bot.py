...
# NEW: Premium/VIP Telegram Stars payment layer
...
# ============================================================
# PREMIUM / VIP TELEGRAM STARS PAYMENTS
# ============================================================
# Must be registered before the generic CallbackQueryHandler.
# Existing premium.py / vip.py / callbacks.py remain unchanged.

register_membership_payment_handlers(telegram_app)
